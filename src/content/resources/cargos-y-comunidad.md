...
```mermaid
graph TD
    A[Asamblea de personas miembros] --> B[Directorio]
    B --> C[Presidencia / Coordinación General]
    B --> D[Tesorería / Finanzas]
    B --> E[Secretaría / Administración]
    B --> I[Presidencia / Coordinación Alumni]

    C --> F[Encargado/a de Eventos, Comunicaciones y Marketing]
    C --> G[Encargado/a de Proyectos / Tech]
    C --> H[Encargado/a de Comunidad e Inclusión]
```
